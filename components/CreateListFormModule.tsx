...
interface Props {
  user: { name?: string | null | undefined; email?: string | null | undefined; image?: string | null | undefined; id?: string | null | undefined; } | null;
}
...
const CreateListFormModule = (props: Props) => {
  ...
  function handleCreateInventoryList() {
    if (!props.user) {
      ...
      createInventoryList(inventoryListName, description, props.user.id!).then((res) => {
        console.log(res);
      });
      togglePopup();
  }
